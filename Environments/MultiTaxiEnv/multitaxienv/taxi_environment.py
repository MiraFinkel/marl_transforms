...
# TODO - Change step function so movement actions happens "simultaneously" and collisions are calculated based on new
#  locations
# TODO - add a track of taxis involved in each passenger trajectory
# TODO - add a costum reward function
